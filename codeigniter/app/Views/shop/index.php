        ...
        <div class="card-body">
            ...
            <?php if ($logged_in): ?>
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <?php if ($owns_shop): ?>
                        <a href="/shop/edit" class="btn btn-primary bg-indigo" style="<?= $shop['theme_color'] ? "background-color: {$shop['theme_color']}; border-color: {$shop['theme_color']}; " : '' ?> <?= $shop['font_color'] ? "color: {$shop['font_color']}; " : '' ?>" >Edit Shop</a>
                    <?php else: ?>
                        <a href="#" class="btn btn-primary bg-indigo" style="<?= $shop['theme_color'] ? "background-color: {$shop['theme_color']}; border-color: {$shop['theme_color']}; " : '' ?> <?= $shop['font_color'] ? "color: {$shop['font_color']}; " : '' ?>" >Contact Shop</a>
                    <?php endif ?>
                </div>
            <?php endif ?>
        </div>
